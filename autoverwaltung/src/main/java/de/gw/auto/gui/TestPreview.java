...
class TestPreview extends JFrame implements ActionListener {
	...
	private JPanel createTextPane() {
		...
		JPanel p = new JPanel(new java.awt.BorderLayout()), top = new JPanel(
	...
	private JPanel createTable() {
		String val[][] = { { "India", "New Delhi" }, { "Nepal", "Katmandu" },
				{ "Afghanistan", "Kabul" }, { "Burma", "Myanmar" },
				{ "China", "Beijing" }, { "Thailand", "Bankok" } };
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (com.equals("Page Setup"))
			...
			new PrintPreview(tp.getPrintable(new MessageFormat(
					"Permutation and Combination"), new MessageFormat("{0}")),
